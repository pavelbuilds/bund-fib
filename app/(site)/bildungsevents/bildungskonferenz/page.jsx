...
export const metadata = {
  ...
  description:
    'Rückblick auf die Bildungskonferenz "Voneinander lernen: Wege zu demokratischem Dialog – Impulse für die Bildung" mit Paneltalk, Workshops und Publikation.',
};
  ...
  return (
    <div className='bg-darkYellow pt-14'>
        ...
        <Container>
          ...
          <YouTubeEmbed videoId='RAmXMhmo1OY' title='Paneltalk der Bildungskonferenz' />
