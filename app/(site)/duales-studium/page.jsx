...
export const metadata = {
  ...
  description:
    'Duales Studium beim Bund-fiB – Theorie trifft Praxis: Studieren und gleichzeitig praktische Erfahrungen sammeln, eigene Projekte übernehmen und in einem engagierten Team mitwirken.',
};
