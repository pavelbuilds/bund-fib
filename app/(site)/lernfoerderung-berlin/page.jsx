...
export const metadata = {
  ...
  description:
    'Ergänzende Lernförderung in Berlin: individuelle Unterstützung für Schülerinnen und Schüler direkt an der Schule, Teil des Bildungs- und Teilhabepakets (BuT).',
};
    ...
    <div className='bg-darkYellow pt-14'>
      ...
      <Container>
        ...
        <p className='pb-10 pt-20  text-lg'>
          Manchmal brauchen Kinder zusätzliche Unterstützung, um in der Schule erfolgreich zu sein.
        ...
        <p className='text-lg pb-10'>
          ...
          gewohnten Umgebung erleichtert und zusätzliche Wege entfallen. Die Förderung kann während
          des Ganztags oder im Nachmittagsbereich stattfinden.
        </p>
        <h3 className='text-xl py-5 font-bold'>Erfahrene Fachkräfte und bewährte Methoden</h3>
        <p className='text-lg pb-10'>
          Unsere Fachkräfte bringen umfangreiche pädagogische Erfahrung mit und nutzen Methoden aus
          der Montessoripädagogik, Lerntherapie und einer individuellen Stärkenorientierung, um
          gezielt auf die Fähigkeiten und Bedürfnisse der Kinder einzugehen. Dabei arbeiten sie eng
          mit den Lehrkräften der Schule zusammen und erstellen regelmäßig Lernberichte, um den
        ...
        <p className='text-lg pb-10'>
          ...
          der Rheinsberger Straße 7. Von dort aus verwalten und gestalten wir die Projekte in Berlin
          und denken, da es sich um unser Hauptquartier handelt, den Bund-fiB weiter.
        </p>
      </Container>
      ...
      <Container>
        <ContactPersonCard
          ...
          address='Rheinsberger Straße 7, 10115 Berlin, Germany'
        />
      </Container>
    </div>
  );
