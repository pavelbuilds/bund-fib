...
export const metadata = {
  ...
  description:
    'Individuelle Lernförderung in Hannover – direkt an Schulen in kleinen Gruppen oder als Einzelförderung zu Hause. In enger Abstimmung mit Lehrkräften und Eltern.',
};
