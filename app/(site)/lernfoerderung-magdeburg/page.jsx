...
export const metadata = {
  ...
  description:
    'Individuelle Deutsch- und Leseförderung in Magdeburg im Rahmen des Bildungs- und Teilhabepakets und des Startchancenprogramms – direkt in der Schule oder im Lernstudio in der Lübecker Straße.',
};
    ...
    <>
      <div className='bg-darkYellow pt-14'>
        ...
        <Container>
          ...
          <p className='text-lg pb-10'>
            Außerdem haben wir in der Lübecker Straße ein Lernstudio, das Kindern und Jugendlichen
