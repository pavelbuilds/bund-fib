...
const ansprechpartnerinnen = [
  {
    ...
    role: 'Geschäftsführung & Projektleitung FFS & Duales Studium',
  ...
  },
  {
    ...
    role: 'Geschäftsführung & Projektleitung FFS',
    phone: '+49 15758756855',
    email: 'soeren.duebel@bund-fib.de',
  },
  {
    name: 'Lars Mikeler',
    image: '/images/mitarbeiter/Bild33.jpeg',
  ...
  },
  {
    ...
    role: 'Standortleitung Hannover & Pressesprecher',
    phone: '+49 176 84919977',
    email: 'benedict.hepp@bund-fib.de',
  },
  {
    name: 'Nathalie Thorleuchter',
    image: '/images/mitarbeiter/platzhalter.svg',
    role: 'Standortleiterin Leipzig & Lernförderung',
  ...
  },
  {
    ...
    role: 'Fit für die Schule',
    phone: '+49 176 11842231',
    email: 'schabnaz.saba@bund-fiB.de',
  },
  {
    name: 'Mika Dombrowski',
    image: '/images/mitarbeiter/Bild29.jpg',
    role: 'Events & Öffentlichkeitsarbeit & BFD',
