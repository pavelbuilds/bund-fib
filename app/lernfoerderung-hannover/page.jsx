    ...
    <>
      ...
      <div className='bg-darkYellow pt-14'>
        ...
        <Container>
          ...
          <h3 className='text-2xl py-10 font-bold'>Lernförderung im eigenen Zuhause</h3>
          ...
          <h3 className='text-2xl py-10 font-bold'>Unser Standort in Hannover</h3>
          <p className='text-lg pb-20'>
            Du findest uns mitten in der Calenberger Neustadt, in einem gemütlichen Hinterhof im
            Co-Working-Space Studiö (Oeltzenstr. 13a, 30169 Hannover). Hier tüfteln wir an neuen
            Projekten und tauschen uns in kreativer Atmosphäre aus – immer mit dem Ziel, Kindern die
