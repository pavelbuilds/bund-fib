...
export default function Home({ feed }) {
  ...
  return (
    <div>
      ...
      {/* Jobs Video Popup */}
      <div
        className={`fixed z-40 h-screen w-screen overflow-hidden bg-lightYellow pt-20 transition-all duration-700 ease-out sm:pt-36 lg:pt-20 ${
          jobsVideo ? 'translate-y-0' : 'translate-y-full'
        }`}
      >
        {/* Container */}
        <Container styling='overflow-scroll'>
          ...
          <div className='flex h-full w-full flex-col items-center justify-center pt-5'>
            <video
              ...
              loop
              playsInline
              className='mb-20 w-[70%] bg-black object-cover brightness-50'
            >
      ...
      <section id='Jobs' className='relative bg-darkYellow'>
        <Container styling={'sm:pt-20 flex justify-center'}>
          ...
          >
            {/* Bild - linke Seite */}
            <div className='hidden w-full sm:w-[50%] lg:block'>
              <Image
                className=' absolute top-1/2 left-1/4 z-50 w-36 -translate-x-1/2 -translate-y-1/2 cursor-pointer'
              ...
              />
              <Image
                className='hidden h-full w-full rounded-tl-3xl rounded-bl-3xl object-cover shadow-2xl brightness-[.6] transition-all lg:block'
            ...
            <div className='mb-12 flex w-full flex-col items-start rounded-3xl bg-white py-20 px-10 shadow-2xl sm:mb-0 sm:px-14 lg:w-[50%] lg:items-start lg:rounded-3xl lg:rounded-tl-none lg:rounded-bl-none'>
              ...
              {/* Beschreibung */}
              <div className='mb-4 text-left font-source leading-tight lg:text-left'>
              ...
              <button
                onClick={toggleJobsVideo}
                className={`mb-5 rounded-full border-2 border-primary bg-white px-9 py-1 font-source text-lg  font-bold text-primary transition-transform sm:h-8 sm:py-0 sm:text-sm lg:hover:scale-[104%]`}
              >
